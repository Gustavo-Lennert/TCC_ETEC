<?php
    ...
    if(empty($_POST['cpf']) || empty($_POST['senha'])){
        ...
        echo "<script>window.location.href='../view/cadUser.php';</script>";
        exit();
    }
    ...
    if($row['total'] > 0){
        ...
        $sql = "INSERT INTO  usuario (cpf, user_nome, senha_user, tipo_user, dataNasc, email, rua, num, cep, cidade, bairro) values ($cpf, '$nome', '$senha', 0, '$dataNasc', '$email', '$rua', $num, $cep, '$cidade', '$bairro')";
        echo "<script>window.location.href='../view/cadUser.php';</script>";
    }
    ...
    $conexao->close();
    exit();
    echo "<script>windo.location.href='../view/cadUser.php';</script>";
