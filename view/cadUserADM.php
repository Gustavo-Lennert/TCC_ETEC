    ...
    <div class="form">
        <main class="user">
            <form action="../controller/cadastroADM.php" method="POST">
                ...
                <!--Conferir se é mesmo necessário ter varios imputs de endereço, pode ser colocado assim -> ex.: endereço: 'rua,numero,bairro'-->
